...
namespace BaseDeDatos603
{
    public partial class Form1 : Form
    {
        ...
        {
            string connection = "datasource=localhost;port=33068;username=Dnlpq66;password=irhN3e0c1Tzu;database=basededatos603";
        ...
        {
            string Connect = "datasource=localhost;port=33068;username=Dnlpq66;password=irhN3e0c1Tzu;database=basededatos603;";
            string query = "SELECT * FROM user";
